...
const LeadCaptureDataAnalystJobs = ({cta}) => {
    ...
    return (
        ...
        <div className='flex flex-col xl:flex-row space-x-8 justify-around my-1'>
              <div className=' basis-1/2 text-blue-700 font-semibold py-2 px-4 border border-yellow-500 shadow-md rounded my-1 xl:my-0'>
                <input 
                  name="email_address" 
              ...
              <div>
                <button data-element="submit" className=' basis-1/2 bg-yellow-300 shadow-md hover:bg-yellow-500 text-blue-700 font-semibold hover:text-blue py-2 px-4 border border-yellow-500 hover:border-transparent rounded'>
                  <div>
                    <div></div>
                    <div></div>
                    <div></div>
