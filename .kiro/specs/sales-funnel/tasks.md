...
- [x] 7. Test and refine complete squeeze page
...
- [x] 8. Create tripwire offer page
...
- [x] 9. Connect squeeze page to tripwire page
...
- [x] 10. Extract content to YAML configuration
