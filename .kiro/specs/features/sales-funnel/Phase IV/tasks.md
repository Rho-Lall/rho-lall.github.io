...
- [ ] 1. Backend API Updates (Separate Repository)
  - [ ] 1.1 Refactor checkout session endpoint for embedded checkout
  ...
  - [ ] 1.2 Create one-click upsell payment endpoint
  ...
  - [ ] 1.3 Create DynamoDB table and webhook for secure payment data storage
  ...
  - [ ] 1.4 Fix parameter naming bug: productId → priceId
...
- [ ] 2. Refactor Embedded Checkout Component (from Phase III)
  - [ ] 2.1 Update existing StripeCheckout component for embedded mode
  ...
  - [ ] 2.2 Update error handling for embedded checkout
  ...
  - [ ] 2.3 Update checkout success handling
...
- [ ] 3. Create Reusable OfferSelection Component and Update Offer Page
  - [ ] 3.1 Create reusable OfferSelection component
  ...
  - [ ] 3.2 Update offer page to use OfferSelection component
...
- [ ] 4. Create Offer Checkout Page
  - [ ] 4.1 Create offer checkout page
...
- [ ] 5. Create One-Click Upsell Page
  - [ ] 5.1 Build one-click upsell page
  ...
  - [ ] 5.2 Implement one-click purchase logic
  ...
  - [ ] 5.3 Add upsell navigation logic
...
- [ ] 5. Create Standard OTO Pages
  - [ ] 5.1 Create standard OTO offer page
...
- [ ] 6. Testing and Deployment
  ...
  - [ ] 6.2 Integration testing (user-performed)
  ...
  - [ ] 6.3 Final verification and deployment
