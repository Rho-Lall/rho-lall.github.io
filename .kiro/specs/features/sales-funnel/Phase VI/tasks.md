...
- [ ] 1. Create funnel-0ps submodule repository
...
- [ ] 2. Extract Layer 1: Independent components
  - _Requirements: 3.1, 3.2, 3.3, 3.4, 3.5, 3.6_

- [ ] 2.1 Extract OfferSelection component
...
- [ ] 2.2 Extract StripeCheckout component
...
- [ ] 3. Extract Layer 2: Content components
  - _Requirements: 3.2, 3.3_

- [ ] 3.1 Extract and rename OfferContent component
...
- [ ] 3.2 Extract and rename OTOContent component
...
- [ ] 4. Create Layer 3: Page templates
  - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7_

- [ ] 4.1 Create OfferPageTemplate
...
- [ ] 4.2 Create CheckoutPageTemplate
...
- [ ] 7.2 Create OTO generation script
...
- [ ] 8.3 Test submodule build
  - Run `gatsby build` to verify host project builds with submodule
  - Fix any build errors
  - _Requirements: 7.4, 9.1_

- [ ] 9. Migrate offer pages to use templates
  - _Requirements: 7.2, 7.5_

- [ ] 9.1 Migrate results-now-ai-action-pack offer page
...
- [ ] 9.2 Migrate results-now-ai-action-pack checkout page
