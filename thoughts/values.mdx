...
Values are inherently fuzzy. We're all seeking them in some form. When you come across a community that can clearly identify its values,  it has an attractive force. It pulls you in. It's something you want to be a part of. It's natural to be drawn in to something that is larger than yourself. We long for that.

When I wasn't simmering on the weekends, I worked at Entrata. One of the things Entrata does exceptionally well is live it’s values. Entrata is a fun place to work. It’s an Entrata value: Business in the front, party in the back. We worked hard, we played hard.  It was easy to adopt Entrata’s values as my own. It was easy to resonate with them. When values are clear it creates trust. It creates a common ground you can build on. It builds the foundation of a relationship.
...
Acknowleging these default shouldy values is an important first step. Acknowledging the bad values isn't the same as discovering the valuable ones. Now, how is discovery achieved? I can only speak to my own journey. It was a long process of figuring things out as I went along. I'm not teaching you anything new; I'm simply reminding you of what you already know.

It's an art to discover values. It's creative expression. It isn't additive, like molding clay. It's subtractive, like carving into stone. You're looking to unearth something under the surface. It's always been there. Don't try to create new values; all you can truely do is expose the real ones.
...
Entrata continuously invests in its values, it's not a one-time thing. It starts with interviews--my friend preped me that they would ask about the company's values. This attracts a certain type of person to Entrata. And every week, we encouraged each other to live up to these values. Values were on display at Values week as well as other company events. Each year during our annual review, we addressed how well we lived up to the Entrata values.

I said before Entrata is a fun place to work: business in the front, party in the back. The symbol of that particular value is the mullet.  At Entrata the conference rooms are named after famous mullets: there is Aggassi, Norris, Bolton, and Cyrus just to name a few. Walk into Norris and the large presentation screen has a screensaver featuring . . . Chuck Norris. That's cool. That's fun. 
...
I bought [Start With Why](https://amzn.to/3Tmc3HF) hoping to learn how. The book comes up short on teaching how. The book focuses on why it matters and at the end Sinek upsells a $100 course to help you find your why. I opted to figure it out on my own-- read still broke. It took a little over a year to nail down a repeatable process. But it was free! If you are interested in learning how I did it, keep reading.
...
My initial efforts were strongly influenced by the [Strengths Finder 2.0 Assessment](https://amzn.to/3KqROVx). I strongly recommend this assessment; it's free when you buy [Strengths Finder 2.0](https://amzn.to/3KqROVx). This is a fantastic tool for determining your natural talents. Your natural strengths set you apart from the crowd; they are your USP and secret sauce. As a result, performing this task is well worth your time. The catch however, even as I studied my talents I was keenly aware that I was missing the mark. Strengths speak to your How not Why. Strengths aren't the same as purpose. 
...
This is starting with Why. This is real progress. This is material acomplishment. This is . . . not enough. This is not going to weather the storm. And the storms come. BeLee-Dat.
...
Finally, fill out your bracket. Hold a tournament for each category (think March Madness). Each value will compete against another. Consider a pair of values. If you have to pick one, which do you keep? The winner advances. Repeat this procedure until there is a clear winner for each category. You can repeat the process to determine second place and so on until your values are ranked for each category.
...
Now your values become a tool. Your values are the foundational data your organization has available to make informed decisions. They are the fundamental building block that drives everything else in the org.
